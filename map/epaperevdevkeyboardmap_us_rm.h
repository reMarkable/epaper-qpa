...
const EpaperEvdevKeyboardMap::Mapping s_keymap_us_rm[] = {
    ...
    { KEY_2, 0x0040, Qt::Key_At, Modifiers::ModShift, 0x00, 0x0000 },
    ...
    { KEY_4, 0x0034, Qt::Key_4, Modifiers::ModAlt, 0x00, 0x0000 },
    { KEY_4, 0x0034, Qt::Key_4, Modifiers::ModAltGr, 0x00, 0x0000 },
    { KEY_4, 0x0024, Qt::Key_Dollar, Modifiers::ModAlt | Modifiers::ModShift, 0x00, 0x0000 },
    { KEY_4, 0x0024, Qt::Key_Dollar, Modifiers::ModAltGr | Modifiers::ModShift, 0x00, 0x0000 },
    ...
    { KEY_6, 0x0302, Qt::Key_Dead_Circumflex, Modifiers::ModShift, Flags::IsDead, 0x0000 },

    // KEY_7 (8)
    // "7" Digit Seven 0x0037
    // "&" Ampersand 0x0026
    { KEY_7, 0x0037, Qt::Key_7, 0x00, 0x00, 0x0000 },
    { KEY_7, 0x0026, Qt::Key_Ampersand, Modifiers::ModShift, 0x00, 0x0000 },

    // KEY_8 (9)
    // "8" Digit Eight 0x0038
    // "*" Asterisk 0x002a
    { KEY_8, 0x0038, Qt::Key_8, 0x00, 0x00, 0x0000 },
    { KEY_8, 0x002a, Qt::Key_Asterisk, Modifiers::ModShift, 0x00, 0x0000 },
    ...
    { KEY_Q, 0x0051, 0x04000051, 0x05, 0x02, 0x0000 },
    { KEY_Q, 0x0071, 0x04000051, 0x06, 0x02, 0x0000 },
    { KEY_Q, 0x0051, 0x04000051, 0x07, 0x02, 0x0000 },
    { KEY_Q, 0x0071, 0x08000051, 0x08, 0x02, 0x0000 },
    { KEY_Q, 0x0051, 0x08000051, 0x09, 0x02, 0x0000 },
    { KEY_Q, 0x0071, 0x08000051, 0x0a, 0x02, 0x0000 },
    { KEY_Q, 0x0051, 0x08000051, 0x0b, 0x02, 0x0000 },
    { KEY_Q, 0x0071, 0x0c000051, 0x0c, 0x02, 0x0000 },
    { KEY_Q, 0x0051, 0x0c000051, 0x0d, 0x02, 0x0000 },
    { KEY_Q, 0x0071, 0x0c000051, 0x0e, 0x02, 0x0000 },
    { KEY_Q, 0x0051, 0x0c000051, 0x0f, 0x02, 0x0000 },
    ...
    { KEY_W, 0x0057, 0x04000057, 0x05, 0x02, 0x0000 },
    { KEY_W, 0x0077, 0x04000057, 0x06, 0x02, 0x0000 },
    { KEY_W, 0x0057, 0x04000057, 0x07, 0x02, 0x0000 },
    { KEY_W, 0x0077, 0x08000057, 0x08, 0x02, 0x0000 },
    { KEY_W, 0x0057, 0x08000057, 0x09, 0x02, 0x0000 },
    { KEY_W, 0x0077, 0x08000057, 0x0a, 0x02, 0x0000 },
    { KEY_W, 0x0057, 0x08000057, 0x0b, 0x02, 0x0000 },
    { KEY_W, 0x0077, 0x0c000057, 0x0c, 0x02, 0x0000 },
    { KEY_W, 0x0057, 0x0c000057, 0x0d, 0x02, 0x0000 },
    { KEY_W, 0x0077, 0x0c000057, 0x0e, 0x02, 0x0000 },
    { KEY_W, 0x0057, 0x0c000057, 0x0f, 0x02, 0x0000 },

    // KEY_E (18)
    { KEY_E, 0x0065, 0x00000045, 0x00, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x00000045, 0x01, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x00000045, 0x02, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x00000045, 0x03, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x04000045, 0x04, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x04000045, 0x05, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x04000045, 0x06, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x04000045, 0x07, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x08000045, 0x08, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x08000045, 0x09, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x08000045, 0x0a, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x08000045, 0x0b, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x0c000045, 0x0c, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x0c000045, 0x0d, 0x02, 0x0000 },
    { KEY_E, 0x0065, 0x0c000045, 0x0e, 0x02, 0x0000 },
    { KEY_E, 0x0045, 0x0c000045, 0x0f, 0x02, 0x0000 },
    ...
    { KEY_A, 0x0061, 0x00000041, 0x02, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x00000041, 0x03, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x04000041, 0x04, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x04000041, 0x05, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x04000041, 0x06, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x04000041, 0x07, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x08000041, 0x08, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x08000041, 0x09, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x08000041, 0x0a, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x08000041, 0x0b, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x0c000041, 0x0c, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x0c000041, 0x0d, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x0c000041, 0x0e, 0x02, 0x0000 },
    { KEY_A, 0x0041, 0x0c000041, 0x0f, 0x02, 0x0000 },
    ...
    // ";" Semicolon 0x003b
    // ":" Colon 0x003a
    { KEY_SEMICOLON, 0x003b, Qt::Key_Semicolon, 0x00, 0x00, 0x0000 },
    { KEY_SEMICOLON, 0x003a, Qt::Key_Colon, 0x01, 0x00, 0x0000 },
    { KEY_SEMICOLON, 0x003b, Qt::Key_Semicolon, 0x02, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003a, Qt::Key_Colon, 0x03, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003b, Qt::Key_Semicolon, 0x04, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003a, Qt::Key_Colon, 0x05, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003b, Qt::Key_Semicolon, 0x06, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003a, Qt::Key_Colon, 0x07, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003b, Qt::Key_Semicolon, 0x08, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003a, Qt::Key_Colon, 0x09, 0x02, 0x0000 },
    { KEY_SEMICOLON, 0x003b, Qt::Key_Semicolon, 0x0a, 0x02, 0x0000 },
    ...
    { KEY_APOSTROPHE, 0x0027, Qt::Key_Apostrophe, Modifiers::ModPlain, 0x00, 0x0000 },
    { KEY_APOSTROPHE, 0x0022, Qt::Key_QuoteDbl, Modifiers::ModShift, 0x00, 0x0000 },
    ...
    { KEY_Z, 0x007a, 0x0000005a, 0x02, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0000005a, 0x03, 0x02, 0x0000 },
    { KEY_Z, 0x007a, 0x0400005a, 0x04, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0400005a, 0x05, 0x02, 0x0000 },
    { KEY_Z, 0x007a, 0x0400005a, 0x06, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0400005a, 0x07, 0x02, 0x0000 },
    { KEY_Z, 0x007a, 0x0800005a, 0x08, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0800005a, 0x09, 0x02, 0x0000 },
    { KEY_Z, 0x007a, 0x0800005a, 0x0a, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0800005a, 0x0b, 0x02, 0x0000 },
    { KEY_Z, 0x007a, 0x0c00005a, 0x0c, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0c00005a, 0x0d, 0x02, 0x0000 },
    { KEY_Z, 0x007a, 0x0c00005a, 0x0e, 0x02, 0x0000 },
    { KEY_Z, 0x005a, 0x0c00005a, 0x0f, 0x02, 0x0000 },

    // KEY_X (45)
    { KEY_X, 0x0078, 0x00000058, 0x00, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x00000058, 0x01, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x00000058, 0x02, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x00000058, 0x03, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x04000058, 0x04, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x04000058, 0x05, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x04000058, 0x06, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x04000058, 0x07, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x08000058, 0x08, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x08000058, 0x09, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x08000058, 0x0a, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x08000058, 0x0b, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x0c000058, 0x0c, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x0c000058, 0x0d, 0x02, 0x0000 },
    { KEY_X, 0x0078, 0x0c000058, 0x0e, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x0c000058, 0x0f, 0x02, 0x0000 },
    ...
    // KEY_M (50)
    { KEY_M, 0x006d, 0x0000004d, 0x00, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0000004d, 0x01, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0000004d, 0x02, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0000004d, 0x03, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0400004d, 0x04, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0400004d, 0x05, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0400004d, 0x06, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0400004d, 0x07, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0800004d, 0x08, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0800004d, 0x09, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0800004d, 0x0a, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0800004d, 0x0b, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0c00004d, 0x0c, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0c00004d, 0x0d, 0x00, 0x0000 },
    { KEY_M, 0x006d, 0x0c00004d, 0x0e, 0x00, 0x0000 },
    { KEY_M, 0x004d, 0x0c00004d, 0x0f, 0x00, 0x0000 },

    // KEY_COMMA (51)
    // "," Comma 0x002c
    // "<" Less-Than Sign 0x003c
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x00, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x01, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x02, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x03, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x04, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x05, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x06, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x07, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x08, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x09, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x0a, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x0b, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x0c, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x0d, 0x00, 0x0000 },
    { KEY_COMMA, 0x002c, Qt::Key_Comma, 0x0e, 0x00, 0x0000 },
    { KEY_COMMA, 0x003c, Qt::Key_Less, 0x0f, 0x00, 0x0000 },

    // KEY_DOT (52)
    // "." Full Stop 0x002e
    // ">" Greater-Than Sign 0x003e
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x00, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x01, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x02, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x03, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x04, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x05, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x06, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x07, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x08, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x09, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x0a, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x0b, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x0c, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x0d, 0x00, 0x0000 },
    { KEY_DOT, 0x002e, Qt::Key_Period, 0x0e, 0x00, 0x0000 },
    { KEY_DOT, 0x003e, Qt::Key_Greater, 0x0f, 0x00, 0x0000 },

    // KEY_SLASH (53)
    // "/" Solidus 0x002f
    // "?" Question Mark 0x003f
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x00, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x01, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x02, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x03, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x04, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x05, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x06, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x07, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x08, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x09, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x0a, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x0b, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x0c, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x0d, 0x00, 0x0000 },
    { KEY_SLASH, 0x002f, Qt::Key_Slash, 0x0e, 0x00, 0x0000 },
    { KEY_SLASH, 0x003f, Qt::Key_Question, 0x0f, 0x00, 0x0000 },
...
const EpaperEvdevKeyboardMap::Composing s_keycompose_us_rm[] = {
