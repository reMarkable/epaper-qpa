...
const EpaperEvdevKeyboardMap::Mapping s_keymap_no[] = {
    ...
    { KEY_1, 0x0027, 0x00000027, Modifiers::ModAlt, 0x00, 0x0000 },
    { KEY_1, 0x0027, 0x00000027, Modifiers::ModAltGr, 0x00, 0x0000 },
    ...
    /* "+"	PLUS SIGN	Basic Latin	0x002B	0x2B00 */
    /* "?"	QUESTION MARK	Basic Latin	0x003F	0x3F00 */
    /* "´"	ACUTE ACCENT	Latin-1 Supplement	0x00B4	0xB400 */
    /* "`"	GRAVE ACCENT	Basic Latin	0x0060	0x6000 */

    { KEY_EQUAL, 0x002b, Qt::Key_Plus, 0x00, 0x00, 0x0000 },
    { KEY_EQUAL, 0x003f, Qt::Key_Question, Modifiers::ModShift, 0x00, 0x0000 },
    { KEY_EQUAL, 0x00b4, Qt::Key_acute, Modifiers::ModAlt, 0x00, 0x0000 },
    { KEY_EQUAL, 0x00b4, Qt::Key_acute, Modifiers::ModAltGr, 0x00, 0x0000 },
    { KEY_EQUAL, 0x0060, Qt::Key_QuoteLeft, Modifiers::ModAlt | Modifiers::ModShift, 0x00, 0x0000 },
    { KEY_EQUAL, 0x0060, Qt::Key_QuoteLeft, Modifiers::ModAltGr | Modifiers::ModShift, 0x00, 0x0000 },
    ...
    { KEY_A, 0x0061, 0x04000041, 0x05, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x04000041, 0x06, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x04000041, 0x07, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x08000041, 0x08, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x08000041, 0x09, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x08000041, 0x0a, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x08000041, 0x0b, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x0c000041, 0x0c, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x0c000041, 0x0d, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x0c000041, 0x0e, 0x02, 0x0000 },
    { KEY_A, 0x0061, 0x0c000041, 0x0f, 0x02, 0x0000 },
    ...
    // original US mappings
    /* { KEY_SEMICOLON, 0x003b, 0x0000003b, 0x00, 0x00, 0x0000 }, */
    /* { KEY_SEMICOLON, 0x003a, 0x0000003a, 0x01, 0x00, 0x0000 }, */
    /* { KEY_APOSTROPHE, 0x0027, 0x00000027, 0x00, 0x00, 0x0000 }, */
    /* { KEY_APOSTROPHE, 0x0022, 0x00000022, 0x01, 0x00, 0x0000 }, */
    /* { KEY_APOSTROPHE, 0x0027, 0x01001251, 0x02, 0x01, 0x0000 }, */
    /* { KEY_APOSTROPHE, 0x0022, 0x01001257, 0x03, 0x01, 0x0000 }, */
    /* { KEY_APOSTROPHE, 0x0067, 0x04000047, 0x04, 0x00, 0x0000 }, */
    /* { KEY_GRAVE, 0x0060, 0x00000060, 0x00, 0x00, 0x0000 }, */
    /* { KEY_GRAVE, 0x007e, 0x0000007e, 0x01, 0x00, 0x0000 }, */
    /* { KEY_GRAVE, 0x0060, 0x01001250, 0x02, 0x01, 0x0000 }, */
    /* { KEY_GRAVE, 0x007e, 0x01001253, 0x03, 0x01, 0x0000 }, */

    { KEY_SEMICOLON, 0x00f8, Qt::Key_Ooblique, 0x00, 0x00, 0x0000 },                                       // ø
    { KEY_SEMICOLON, 0x00d8, Qt::Key_Ooblique, Modifiers::ModShift, 0x00, 0x0000 },                        // capital
    { KEY_APOSTROPHE, 0x00e6, Qt::Key_AE, 0x00, 0x00, 0x0000 },                                            // æ
    { KEY_APOSTROPHE, 0x00c6, Qt::Key_AE, Modifiers::ModShift, 0x00, 0x0000 },                             // capital
    ...
    { KEY_GRAVE, 0x00e5, Qt::Key_Aring, 0x00, 0x00, 0x0000 },                                              // å
    { KEY_GRAVE, 0x00c5, Qt::Key_Aring, Modifiers::ModShift, 0x00, 0x0000 },                               // capital
    { KEY_GRAVE, 0x005e, Qt::Key_Dead_Circumflex, Modifiers::ModAltGr, Flags::IsDead, 0x0000 },            // circumflex accent (^)
    { KEY_GRAVE, 0x005e, Qt::Key_Dead_Circumflex, Modifiers::ModAlt, Flags::IsDead, 0x0000 },              // circumflex accent (^)

    // FIXME: doesn't seem to work properly.. hmm
    { KEY_GRAVE, 0x00a8, Qt::Key_Dead_Diaeresis, Modifiers::ModShift | Modifiers::ModAltGr, Flags::IsDead, 0x0000 }, // diaeresis accent (¨)
    ...
    // 0x003f ?
    // desired: -_~
    // "-"	HYPHEN-MINUS	Basic Latin	0x002D	0x2D00
    // "_"	LOW LINE	Basic Latin	0x005F	0x5F00
    // "~"	TILDE	Basic Latin	0x007E	0x7E00

    { KEY_SLASH, 0x002d, 0x0000002d, 0x00, 0x00, 0x0000 },
    { KEY_SLASH, 0x005f, 0x0000005f, 0x01, 0x00, 0x0000 },
    { KEY_SLASH, 0x007e, 0x0000007e, Modifiers::ModAlt, 0x00, 0x0000 },
    { KEY_SLASH, 0x007e, 0x0000007e, Modifiers::ModAltGr, 0x00, 0x0000 },
