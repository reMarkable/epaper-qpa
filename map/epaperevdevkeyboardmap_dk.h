...
const EpaperEvdevKeyboardMap::Mapping s_keymap_dk[] = {
    ...
    { KEY_1, 0x0027, Qt::Key_Apostrophe, Modifiers::ModAlt, 0x00, 0x0000 },
    { KEY_1, 0x0027, Qt::Key_Apostrophe, Modifiers::ModAltGr, 0x00, 0x0000 },
    ...
    // "´" Acute Accent 0x00b4
    // "`" Grave Accent 0x0060
    { KEY_EQUAL, 0x002b, Qt::Key_Plus, 0x00, 0x00, 0x0000 },
    ...
    { KEY_EQUAL, 0x0060, Qt::Key_Dead_Grave, Modifiers::ModAlt | Modifiers::ModShift, Flags::IsDead, 0x0000 },
    { KEY_EQUAL, 0x0060, Qt::Key_Dead_Grave, Modifiers::ModAltGr | Modifiers::ModShift, Flags::IsDead, 0x0000 },
    ...
    // KEY_TAB (15)
    { KEY_TAB, 0xffff, Qt::Key_Tab, 0x00, 0x00, 0x0000 },
    ...
    // "'" Apostrophe 0x0027
    // "*" Asterisk 0x002a
    { KEY_APOSTROPHE, 0x00f8, Qt::Key_Ooblique, 0x00, Flags::IsLetter, 0x0000 },
    { KEY_APOSTROPHE, 0x00d8, Qt::Key_Ooblique, Modifiers::ModShift, Flags::IsLetter, 0x0000 },
    ...
    // KEY_GRAVE (41)
    // "å" Latin Small Letter a with Ring Above 0x00e5
    ...
    { KEY_Z, 0x003c, Qt::Key_Less, 0x04, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x05, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x06, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x07, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x08, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x09, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x0a, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x0b, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x0c, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x0d, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x0e, 0x00, 0x0000 },
    { KEY_Z, 0x003c, Qt::Key_Less, 0x0f, 0x00, 0x0000 },

    // KEY_X (45)
    // ">" Greater-Than Sign 0x003e
    { KEY_X, 0x0078, 0x00000058, 0x00, 0x02, 0x0000 },
    { KEY_X, 0x0058, 0x00000058, 0x01, 0x02, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x00000058, 0x02, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x00000058, 0x03, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x04000058, 0x04, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x04000058, 0x05, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x04000058, 0x06, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x04000058, 0x07, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x08000058, 0x08, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x08000058, 0x09, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x08000058, 0x0a, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x08000058, 0x0b, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x0c000058, 0x0c, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x0c000058, 0x0d, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x0c000058, 0x0e, 0x00, 0x0000 },
    { KEY_X, Qt::Key_Greater, 0x0c000058, 0x0f, 0x00, 0x0000 },
